    ...
    if(isset($_POST['submit'])) {
      ...
      if(mysqli_num_rows($select_users)!=0){
        ...
        if($password !=$cpassword){
          ...
          mysqli_query($conn, "INSERT INTO users_info(`name`, `email`, `password`, `user_type`) VALUES('$name','$email','$password','$user_type')") or die('Query failed');
  ...
  <?php
    ...
    <div class="container">
      <form action="" method="post">
         <h3 style="color:white">Register to Use <a href="index.php"><span>Hamro Book  </span><span>Pasal</span></a></h3>
         <input type="text" name="Name" placeholder="Enter Your Name" required class="text_field ">
